...
w1 = GameSprite("wall texture 1.jpg", win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite("wall texture 1.jpg", 370, 100, 50, 400)
...
monster1 = Enemy("ghost.png", win_width - 80, 110,80,80,2)
monster2 = Enemy("ghost.png", win_width - 250, 250,80,80,2)
monsters.add(monster1)
monsters.add(monster2)

final_sprite = GameSprite("finish_flag.png", win_width - 85, win_height - 100, 80,80)
